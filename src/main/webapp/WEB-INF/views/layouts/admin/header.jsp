...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="index3.html" class="brand-link"> <img
		src='<c:url value="/static/image/manager.png" />' alt="AdminLTE Logo"
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column"
               ...
               with font-awesome or any other icon font library -->
				...
				<li class="nav-item"><a
					href="<c:url value="/admin/mau-sac/trang-chu"  />" class="nav-link">
				...
				<li class="nav-item"><a
					href="<c:url value="/admin/banner/trang-chu"  />" class="nav-link">
						<i class="nav-icon far fa-images"></i>
						<p>Quản lý banner</p>
				</a></li>

				<li class="nav-item"><a
					href="<c:url value="/admin/thong-ke/"  />" class="nav-link"> <i
						class="nav-icon far fa-chart-bar"></i>
						<p>Thống kê
							<i class="right fas fa-angle-left"></i>
						</p>
				</a>
					...
					<ul class="nav nav-treeview">
						...
						<li class="nav-item"><a
							href="<c:url value="/admin/thong-ke/thang"  />" class="nav-link"> <i
								class="far fa-circle nav-icon"></i>
								<p>Thống kê tháng</p>
						</a></li>
						...
						<li class="nav-item"><a
							href="<c:url value="/admin/thong-ke/nam"  />" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Thống kê năm</p>
						</a></li>
